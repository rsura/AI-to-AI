...
DEFAULTS: dict = {
    ...
    "messages_ai1": [],         # message dicts from AI1's perspective
    "messages_ai2": [],         # message dicts from AI2's perspective
    ...
    "openrouter_api_key": "",   # OpenRouter API key, stored at conversation start
}
